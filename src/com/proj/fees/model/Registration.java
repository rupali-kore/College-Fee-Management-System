 ...
 * Represents a student record and their fee details.
 */
public class Registration implements Serializable {
    ...
    private String tfee; // Total/Semester Fee
    private String sfee; // Submitted Fee
    private String fine;
    ...
    public String getTfee() { return tfee; }
    public void setTfee(String tfee) { this.tfee = tfee; }

    public String getSfee() { return sfee; }
    public void setSfee(String sfee) { this.sfee = sfee; }

    public String getFine() { return fine; }
    public void setFine(String fine) { this.fine = fine; }

    public String getFeeSubmissionDate() { return feeSubmissionDate; }
    public void setFeeSubmissionDate(String feeSubmissionDate) { this.feeSubmissionDate = feeSubmissionDate; }
    ...
    public String toString() {
        return "Student[ID=" + id + ", Name=" + name + ", Status=" + feeStatus + "]";
    }
    
    // Registration क्लासच्या आत हे ॲड करा
private String firstDateSubmission;

public String getFirstDateSubmission() {
    return firstDateSubmission;
}

public void setFirstDateSubmission(String firstDateSubmission) {
    this.firstDateSubmission = firstDateSubmission;
}
}